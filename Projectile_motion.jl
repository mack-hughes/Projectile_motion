...
# ╔═╡ 316b8d62-5a68-4d82-92d8-7daea1a1ebe3
  using DifferentialEquations, Plots, PlutoUI; plotly()

# ╔═╡ d02989e6-e671-11ed-28bb-2d095a9649dd
md"""
# Projectile motion
"""

# ╔═╡ b862782b-a647-4204-b6c6-5c9a60e9b450
TableOfContents()

# ╔═╡ 9fcde70d-9f02-45c9-ad66-df7eefa7e0b6
md"""
### A second order differential equation 
"""

# ╔═╡ e3fcb344-814c-426a-8af0-8a18ad021d29
md"""
$\dfrac{d^2u}{dt^2}=f(du, u, g, t)$
"""

# ╔═╡ 1e604b02-cccd-4c60-984f-e3addfe0345e
md"""
where $u$ is a vector $\begin{bmatrix} y \\ x\end{bmatrix}$
"""

# ╔═╡ 3eb53db2-0a0a-452e-ba66-63f401d23051
md"""
### Gravity g $(@bind gravity TextField(default="-9.8"))
"""

# ╔═╡ 080cfd67-ff62-44c4-b66d-7938ea367988
g = parse(Float64, gravity)

# ╔═╡ bfeeb96d-a4b7-4957-b1ba-0ab699c87f8d
md"""
### $\dfrac{dy}{dt}\_begin$ $(@bind  dydt0 TextField(default="1"))
"""

# ╔═╡ d56d42c9-1126-4d79-9e42-794f77a99d05
dydt₀ = parse(Float64, dydt0)

# ╔═╡ 30bafbc0-f816-473d-91e0-b2196ef9020a
md"""
### $\dfrac{dx}{dt}\_begin$ $(@bind  dxdt0 TextField(default="1"))
"""

# ╔═╡ 7e41eecd-cc64-426f-a42e-993795d6dfd5
dxdt₀ = parse(Float64, dxdt0)

# ╔═╡ dcb0933a-ee90-43d6-bc3e-1176856e754f
md"""
### $\dfrac{du}{dt}\_begin$ $(@bind  dudt0 TextField(default="1"))
"""

# ╔═╡ 39eb6322-8822-4bfe-bbda-e28beba6a099
dudt₀ = parse(Float64, dudt0)

# ╔═╡ 69943393-967e-429d-8696-261ee9e675c9
θ = dydt₀/dxdt₀

# ╔═╡ f7210b48-aa70-4fda-a9fe-c9a79be7bce2
md"""
### θ₀ = $(θ)
"""

# ╔═╡ f4e4af30-9e50-4101-9ceb-fde0b8ac4e30
md"""
### $x₀$ $(@bind  x0 TextField(default="0"))
"""

# ╔═╡ 2874f253-f5cf-419a-bac8-d4cb84f50710
x₀ = parse(Float64, x0)

# ╔═╡ b70be4b2-e296-41c9-993a-3e84eb84541c
md"""
### $y₀$ $(@bind  y0 TextField(default="0"))
"""

# ╔═╡ 7fd9574c-2335-4dd8-85f8-615a9656f35e
y₀ = parse(Float64, y0)

# ╔═╡ 3a5280bf-446e-483c-bf06-055b760b0f02
md"""
### $t\_begin$ $(@bind  t0 TextField(default="0"))
"""

# ╔═╡ 9f5585c5-109a-4c1c-b43e-b195b1243a81
t_begin = parse(Float64, t0)

# ╔═╡ 6b2265f4-0c4b-4b15-9a19-ff403ef7749e
md"""
### Time t $(@bind t_end Slider(0.0:0.1:20.0, 20.0, true))
"""
